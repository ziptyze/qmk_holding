...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    [_ONE] =  LAYOUT_ortho_4x12 (
        ...
        RGB_MOD,   KC_LCTL, KC_LALT, KC_LGUI, KC_LSFT, KC_SPC, KC_SPC, MO(1), KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
    ),
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [_TWO]   =  { ENCODER_CCW_CW(KC_TRNS, KC_TRNS) },
    [_THREE] =  { ENCODER_CCW_CW(KC_TRNS, KC_TRNS) },
    [_FOUR]  =  { ENCODER_CCW_CW(KC_TRNS, KC_TRNS) },
};
#endif
